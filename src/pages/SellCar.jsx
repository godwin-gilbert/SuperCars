          ...
          <div className="offer__list">
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">Athiyaman</h3>
                <h6 className="avg__price">
                  ₹1,116,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is ₹1,116,244</h6>
              ...
              <div className="box__03">
                ...
                <h6 className="spend__amount">₹1,111,174</h6>
              ...
              <div className="box__04">
                ...
                <h6 className="spend__amount">₹1,117,174</h6>
                <p className="spend__title">Market Worth</p>
              </div>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">₹9,111</h6>
                <p className="spend__title">Spend Per Unit Turned</p>
              </div>
            </div>
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">Godwin</h3>
                <h6 className="avg__price">
                  ₹1,111,605 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is ₹1,111,244</h6>
                <span className="arrow__key">
                  <i class="ri-arrow-right-line"></i>
                </span>
              </div>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">₹3,811</h6>
                <p className="spend__title">Spend Per Unit Turned</p>
              </div>
            </div>
          </div>
